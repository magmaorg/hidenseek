...
public class EntityHider implements Listener {
    ...
    public EntityHider(Plugin plugin, Policy policy) {
        ...
        plugin.getServer()
                .getPluginManager()
                .registerEvents(bukkitListener = constructBukkit(), plugin);
     ...
     *
     * <p>If the entity is visible, it will be hidden. If it is hidden, it will become visible.
     *
     * @param observer - the player observer.
     ...
     *
     * <p>Note that the entity may very well be occluded or out of range from the perspective of the
     * observer. This method simply checks if an entity has been completely hidden for that
     * observer.
     *
     * @param observer - the observer.
