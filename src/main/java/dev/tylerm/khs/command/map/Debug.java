...
public class Debug implements ICommand {
        ...
        debugMenu.setItem(
                ...
                createOption(
                        ...
                        player -> {
                            ...
                            if (Main.getInstance().getGame().getStatus()
                                    != dev.tylerm.khs.game.util.Status.STARTING)
    ...
    private ItemStack createOption(
            Map<Integer, Consumer<Player>> functions,
            int slow,
            Material material,
            String name,
            int amount,
    ...
    public List<String> autoComplete(@NotNull String parameter, @NotNull String typed) {
        if (parameter.equals("map")) {
            return Maps.getAllMaps().stream()
                    .map(dev.tylerm.khs.configuration.Map::getName)
