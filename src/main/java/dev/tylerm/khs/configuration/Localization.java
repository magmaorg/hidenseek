...
public class Localization {
    ...
    private static final Map<String, String[][]> CHANGES =
    ...
    public static void loadLocalization() {
        ...
        if (VERSION < PLUGIN_VERSION) {
            for (int i = VERSION; i < PLUGIN_VERSION; i++) {
                ...
                for (String change : changeList) manager.reset("Localization." + change);
            }
            ...
            LOCAL.put(
                    ...
                    new LocalizationString(
                            ChatColor.translateAlternateColorCodes(
                                    '&', manager.getString("Localization." + key))));
        }
            ...
            if (defaultMessage == null) {
                return new LocalizationString(
                        ChatColor.RED
                                ...
                                + ChatColor.ITALIC
                                + key
                                + " is not found in localization.yml. This is a plugin issue,"
                                + " please report it.");
            }
